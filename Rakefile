...
task :build do
  ...
  FileUtils.rm_r Dir["build/app/*"] - Dir["build/app/{application,modernizer,note}.js"], verbose: true
  FileUtils.rm_r Dir["build/stylesheets/*"] - Dir["build/stylesheets/{application,note}.css"], verbose: true
end
